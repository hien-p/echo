...
export function MarketingHero({ startColors, endColors }: HeroProps = {}) {
      ...
      >
        <h1 className="text-[clamp(3rem,8vw,12rem)] leading-[1.05] tracking-tight text-foreground">
          ...
          <span className="block overflow-hidden pb-[0.1em]">
            ...
            >
              <em className="font-serif">belongs to you.</em>
            </motion.span>
          </span>
        </h1>
        ...
        >
          Echo is a Walrus-native form platform — gas-sponsored answers,
          Seal-encrypted private tiers, on-chain composability via Sui. Nothing
          else builds this on Google Forms.
        </motion.p>
        ...
        >
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-foreground px-6 py-3 text-base font-semibold text-background shadow-lg transition hover:opacity-90"
          >
